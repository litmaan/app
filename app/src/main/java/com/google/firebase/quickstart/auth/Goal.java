...
public class Goal extends AppCompatActivity {
    ...
    View.OnClickListener sendToDatabaseOnClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            String widthString = weight.getText().toString();
            String heightString = height.getText().toString();
            if (ageString.isEmpty() || widthString.isEmpty() || heightString.isEmpty()) {
                Toast.makeText(Goal.this, "Wszystkie pola muszą być uzupełnione", Toast.LENGTH_SHORT).show();
            }else if (!ageString.matches(reg) || !widthString.matches(reg) || !heightString.matches(reg)) {
